const fs = require('fs');
const RoleHook = require('../modules/enabled/rolehook/RoleHook');
const Permission = require('../modules/enabled/permission/Permission');
const ResourceHook = require('../modules/enabled/resourcehook/ResourceHook');
